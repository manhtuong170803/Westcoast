...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'custom-editor-style-bootstrap4-styles', get_template_directory_uri() . '/css/custom-editor-style-bootstrap4.min.css', array(), $css_version );
		wp_enqueue_style( 'custom-editor-styles', get_template_directory_uri() . '/css/custom-editor-style.min.css', array(), $css_version );
		wp_enqueue_style( 'theme-bootstrap4-styles', get_template_directory_uri() . '/css/theme-bootstrap4.min.css', array(), $css_version );
